 ...
 *
 * Status Trans Packet Proto DataSize Class CMD Args
 * 00     1f    0000   00    0e       0f    03  000000000200ffaa00ffaa00ffaa | SET LED MATRIX Effect (NOSTR, Main light (0x00), Static 0x00 (Unknown), Static 0x00 (Unknown), RGB 0x00FFAA, RGB 0x00FFAA, RGB 0x00FFAA)
 * 00     1f    0000   00    0e       0f    03  0000000002aa00ffaa00ffaa00ff | SET LED MATRIX Effect (NOSTR, Main light (0x00), Static 0x00 (Unknown), Static 0x00 (Unknown), RGB 0xAA00FF, RGB 0xAA00FF, RGB 0xAA00FF)
 */
